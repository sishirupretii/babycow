...
CloudflareApps.siteId = "68292cbd3665a6c4801215ef132ec367";
...
CloudflareApps.installs["AaIciI0FmNsk"] = {
    appId: "G95etHM0hEOF",
    scope: {}
};;
CloudflareApps.installs["AaIciI0FmNsk"].options = {
    "account": {
        "accountId": "gRuBlzNUv84a",
        "service": "tawk-to",
        "userId": "5b7d06473481f60ed914f419"
    },
    "location": {
        "method": "prepend",
        "selector": "body"
    },
    "property": "64f999e4a91e863a5c1228c9",
    "widget": "inline:1h9ng29ao"
};;
CloudflareApps.installs["AaIciI0FmNsk"].URLPatterns = ["^bitrixinfotech.com/?$", "^bitrixinfotech.com/ecommerce-clone/?.*$", "^bitrixinfotech.com/nft-opensea-clone-script/?.*$", "^bitrixinfotech.com/on-demand-service-clone/?.*$", "^bitrixinfotech.com/p2p-crypto-exchange-clone-script/?.*$", "^bitrixinfotech.com/taxi-app-clone/?.*$", "^theme.bitrixinfotech.com/?.*$"];;
CloudflareApps.installs["AaIciI0FmNsk"].selectors = {
    "location.selector": "body"
};
(function() {
    var script = document.createElement('script');
    script.src = '/cdn-cgi/apps/body/LgZigiZwRnrRpeVvU69Jf9Q3sR0.js';
